...
kiet_image = face_recognition.load_image_file("./known/kiet.jpg")
...
imani_face_encoding = face_recognition.face_encodings(imani_image)[0]

# Load a second sample picture and learn how to recognize it.
raiyan_image = face_recognition.load_image_file("./known/raiyan.jpg")
raiyan_face_encoding = face_recognition.face_encodings(raiyan_image)[0]
